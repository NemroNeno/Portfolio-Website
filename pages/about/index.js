...
const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title:
          "Computer Vision Intern - MachVis-Lab (National University of Science and Technology, Islamabad)",
        stage: "2024 - present",
      },
      {
        title:
          "Deep Learning Intern - ONT-Lab (National University of Science and Technology, Islamabad)",
        stage: "2024 - Present",
      },
      {
    ...
    <div className="h-full bg-primary/60 max-sm:py-[120px] sm:py-32 text-center xl:text-left overflow-auto lg:overflow-hidden scrollbar-hide  ">
      ...
      <div className=" container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-5 pb-[200px] lg:mt-[100px]">
        <div className="flex-l flex flex-col justify-center text-sm sm:pt-[50px]">
          ...
          <motion.p
            className="max-w-[500px] mx-auto xl:mx-0 xl:mb-12 px-2 xl:px-0 pt-[50px] mb-[100px]"
            variants={fadeIn("right", 0.6)}
            initial="hidden"
            animate="show"
            exit="hidden"
          >
            Some of the skills I have aquired over the years include web
            development, programming, and data science/machine learning. I have
            also gained experience in computer vision, deep learning, and
            machine learning. I have also earned certifications in advanced
            react, machine learning specialisation, and advanced programming in
            C++.
          </motion.p>
          ...
          >
            <div>
              <div
                className="relative hidden xl:flex xl:gap-x-10 justify-around mb-16
        ...
        <motion.div
          className="flex flex-col w-[350px] md:w-[500px]  xl:max-w-[48%] max-sm:mb-[300px] h-[900px] md:h-[480px] md:mr-[90px]  max-sm:pb-[800px] "
        ...
        >
          ...
          <div className="bg-pink-400/10 py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start w-[350px] md:w-[650px] rounded-xl md:mr-[90px]">
            {aboutData[index].info.map((item, itemIndexed) => {
              return (
                <div key={itemIndexed}>
                  <div className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-white/80 md:text-xl  mx-2">
                    ...
                    <div className="flex gap-x-4">
                      {item.icons?.map((icon, iconIndex) => {
                        return (
                          <div
                            key={iconIndex}
                            className="group relative max-sm:text-xl md:text-4xl hover:text-accent transition-all duration-300"
                            content={<span>Tooltip</span>}
                          >
                            {
                              <span className="invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-opacity duration-300 absolute bottom-full mb-2 w-max  text-white text-sm rounded py-2 px-1 shadow-lg">
                                {item.names[iconIndex]}
                              </span>
                            }
                            {icon}
                          </div>
