  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10 ">
        <div className="text-center flex flex-col justify-center xl:pt-10 md:text-left pt-[70px] h-full container mx-auto max-sm:pt-0">
          <motion.h4
        ...
        /> </span>Together.
          ...
          <motion.p
            ...
            animate="show"
            exit="hidden"
            className="max-w-sm sm:max-w-md mx-auto md:mx-0 mb-0 sm:mb-16 !z-50  max-sm:!text-xs max-sm:text-white/85"
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        <div
          className=" bg-explosion bg-cover bg-right 
        bg-no-repeat w-full h-full absolute mix-blend-color-dodge translate-z-5"
        ></div>
