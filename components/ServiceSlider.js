      ...
      {serviceData.map((item, index) => {
        return (
          <SwiperSlide key={index}>
            <div className="bg-[rgba(65,47,123,0.15)] h-max rounded-lg px-6 py-8 flex sm:flex-col gap-x-6 sm:h-max group cursor-pointer !z-50 hover:bg-[rgba(89,65,169,0.15)] transition-all duration-300">
